...
public abstract class AbstractResourceManager implements IResourceManager {
	...
	/* (non-Javadoc)
	 * @see org.soumyak.util.resource.IResourceManager#spawnVM()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.soumyak.util.resource.IResourceManager#stopVM()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.soumyak.util.resource.IResourceManager#getVM()
	 */
	@Override
	public List getVM() {
		// TODO Auto-generated method stub
